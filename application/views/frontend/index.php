...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/css/loader.min.css"> <!-- LOADER STYLE SHEET -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/css/bootstrap.min.css"><!-- BOOTSTRAP STYLE SHEET -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/css/fontawesome/css/font-awesome.min.css" /><!-- FONTAWESOME STYLE SHEET -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/css/owl.carousel.min.css"><!-- OWL CAROUSEL STYLE SHEET -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/css/magnific-popup.min.css"><!-- MAGNIFIC POPUP STYLE SHEET -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/css/style.css"><!-- MAIN STYLE SHEET -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/css/rev-slider-4.css"><!-- REVOLUTION SLIDER 4 STYLE -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/plugins/revolution/revolution/css/settings.css"><!-- REVOLUTION SLIDER CSS -->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/plugins/revolution/revolution/css/navigation.css"><!-- REVOLUTION NAVIGATION STYLE -->
    <!-- GOOGLE FONTS -->
...
<body>
	...
	<div class="page-wraper"> 
                    ...
                    <div class="container">
                        <div class="logo-header">
                        	<div class="logo-header-inner logo-header-one">
                            	<a href="index.html">
                                <img src="<?php echo base_url();?>public/images/logo-dark.png" width="171" height="49" alt="" />
                            </a>
                            </div>
                        </div>
                        <!-- ETRA Nav -->
        ...
        <div class="page-content">
                ...
                <div id="welcome" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.3.1">
                    <ul>	
                                    ...
                                    style="z-index: 7; white-space: nowrap; font-size: 20px; line-height: 22px; font-weight: 400; color: #ffffff; letter-spacing: 0px;">
                                        ...
                                        <div class="tp-caption  " 
                                            ...
                                            <div class="tp-caption   tp-resizeme  tp-linkmod" 
                                                ...
                                                style="z-index: 11; white-space: normal; font-weight: 600; color: #fff; letter-spacing: 2px; display: inline-block;
                        ...
                        <li data-index="rs-903" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="<?php echo base_url();?>public/images/main-slider/slider1/slide2.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="300" data-fsslotamount="7" data-saveperformance="off"  data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="<?php echo base_url();?>public/images/main-slider/slider1/slide2.jpg"  alt=""  data-lazyload="<?php echo base_url();?>public/images/main-slider/slider1/slide2.jpg" data-bgposition="center center"
                            data-bgfit="cover" data-bgparallax="4" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                        ...
                        <li data-index="rs-904" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="<?php echo base_url();?>public/images/main-slider/slider1/slide3.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="300" data-fsslotamount="7" data-saveperformance="off"  data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="<?php echo base_url();?>public/images/main-slider/slider1/slide3.jpg"  alt=""  data-lazyload="<?php echo base_url();?>public/images/main-slider/slider1/slide3.jpg" data-bgposition="center center"
                            data-bgfit="cover" data-bgparallax="4" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            		...
                            		<div class="owl-carousel home-carousel-1 owl-btn-vertical-center">
                                        ...
                                        <div class="item">
                                            <div class="ow-img wt-img-effect zoom-slow">
                                                <a href="about-1.html"><img src="<?php echo base_url();?>public/images/gallery/pic1.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <!-- COLUMNS 2 -->
                                        <div class="item">
                                            <div class="ow-img wt-img-effect zoom-slow">
                                                <a href="about-1.html"><img src="<?php echo base_url();?>public/images/gallery/pic2.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <!-- COLUMNS 3 -->
                                        <div class="item">
                                            <div class="owl-img wt-img-effect zoom-slow">
                                                <a href="about-1.html"><img src="<?php echo base_url();?>public/images/gallery/pic3.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <!-- COLUMNS 4 -->
                                        <div class="item">
                                            <div class="ow-img wt-img-effect zoom-slow">
                                                <a href="about-1.html"><img src="<?php echo base_url();?>public/images/gallery/pic4.jpg" alt=""></a>
                                            </div>
                                        </div>
                                        <!-- COLUMNS 5 -->
                                        <div class="item">
                                            <div class="ow-img wt-img-effect zoom-slow">
                                                <a href="about-1.html"><img src="<?php echo base_url();?>public/images/gallery/pic5.jpg" alt=""></a>
                                            </div>
                                        </div>
                                   </div>
                               </div>
                    ...
                    <div class="owl-carousel owl-carousel-filter  owl-btn-bottom-left">
                        ...
                        <div class="item fadingcol building-col">
                            <div class="wt-img-effect ">
                                <img src="<?php echo base_url();?>public/images/gallery/portrait/pic1.jpg" alt="">
                                <div class="overlay-bx-2 ">
                                    <div class="line-amiation">
                                        <div class="text-white  font-weight-300 p-a40">
                                            <h2><a href="project-detail.html" class="text-white font-20 letter-spacing-4 text-uppercase">Triangle Concrete House on lake</a></h2>
                        ...
                        <div class="item fadingcol  building-col">
                            <div class="wt-img-effect ">
                                <img src="<?php echo base_url();?>public/images/gallery/portrait/pic2.jpg" alt="">
                                <div class="overlay-bx-2 ">
                                    <div class="line-amiation">
                                        <div class="text-white  font-weight-300 p-a40">
                                            <h2><a href="project-detail.html" class="text-white font-20 letter-spacing-4 text-uppercase">Triangle Concrete House on lake</a></h2>
                        ...
                        <div class="item fadingcol building-col">
                            <div class="wt-img-effect ">
                                <img src="<?php echo base_url();?>public/images/gallery/portrait/pic3.jpg" alt="">
                                <div class="overlay-bx-2 ">
                                    <div class="line-amiation">
                                        <div class="text-white  font-weight-300 p-a40">
                                            <h2><a href="project-detail.html" class="text-white font-20 letter-spacing-4 text-uppercase">Triangle Concrete House on lake</a></h2>
                        ...
                        <div class="item fadingcol building-col">
                            <div class="wt-img-effect ">
                                <img src="<?php echo base_url();?>public/images/gallery/portrait/pic4.jpg" alt="">
                                <div class="overlay-bx-2 ">
                                    <div class="line-amiation">
                                        <div class="text-white  font-weight-300 p-a40">
                                            <h2><a href="project-detail.html" class="text-white font-20 letter-spacing-4 text-uppercase">Triangle Concrete House on lake</a></h2>
                        ...
                        <div class="item fadingcol interior-col">
                            <div class="wt-img-effect ">
                                <img src="<?php echo base_url();?>public/images/gallery/portrait/pic5.jpg" alt="">
                                <div class="overlay-bx-2 ">
                                    <div class="line-amiation">
                                        <div class="text-white  font-weight-300 p-a40">
                                            <h2><a href="project-detail.html" class="text-white font-20 letter-spacing-4 text-uppercase">Triangle Concrete House on lake</a></h2>
                        ...
                        <div class="item fadingcol restaurant-col">
                            <div class="wt-img-effect ">
                                <img src="<?php echo base_url();?>public/images/gallery/portrait/pic6.jpg" alt="">
                                <div class="overlay-bx-2 ">
                                    <div class="line-amiation">
                                        <div class="text-white  font-weight-300 p-a40">
                                            <h2><a href="project-detail.html" class="text-white font-20 letter-spacing-4 text-uppercase">Triangle Concrete House on lake</a></h2>
                        ...
                        <div class="item fadingcol restaurant-col">
                            <div class="wt-img-effect ">
                                <img src="<?php echo base_url();?>public/images/gallery/portrait/pic7.jpg" alt="">
                                <div class="overlay-bx-2 ">
                                    <div class="line-amiation">
                                        <div class="text-white  font-weight-300 p-a40">
                                            <h2><a href="project-detail.html" class="text-white font-20 letter-spacing-4 text-uppercase">Triangle Concrete House on lake</a></h2>
            ...
            <div class="section-full p-t140 clearfix bg-repeat tm-wo-we-r" style="background-image:url(<?php echo base_url();?>public/images/background/ptn-1.png);">
                            	...
                            	<div class="m-carousel-2">
                            		<div class="owl-carousel carousel-hover home-carousel-2 owl-btn-vertical-center">
                                        ...
                                        <div class="item">
                                        	<div class="wt-box">
                                                <div class="ow-img wt-carousel-block gradi-black">
                                                    <img src="<?php echo base_url();?>public/images/projects/pic-1.jpg" alt="">
                                                    <div class="p-a50 wt-carousel-info text-white">
                                                    	<div class="carousel-line">
                                                              <h2 class="font-28 font-weight-400 m-b10">New Acropolis Museum</h2>
                                                              <p class="m-b0">Mattis ex non urna condimentum, eget eleifend diam molestie. Curabitur lorem enimnulla sed, 
                                        ...
                                        <div class="item">
                                            <div class="wt-box">
                                                <div class="ow-img wt-carousel-block gradi-black">
                                                    <img src="<?php echo base_url();?>public/images/projects/pic-2.jpg" alt="">
                                                    <div class="p-a50 wt-carousel-info text-white">
                                                    	<div class="carousel-line">
                                                              <h2 class="font-28 font-weight-400 m-b10">New Acropolis Museum</h2>
                                                              <p class="m-b0">Mattis ex non urna condimentum, eget eleifend diam molestie. Curabitur lorem enimnulla sed, 
                                        ...
                                        <div class="item">
                                            <div class="wt-box">
                                                <div class="ow-img wt-carousel-block gradi-black">
                                                    <img src="<?php echo base_url();?>public/images/projects/pic-3.jpg" alt="">
                                                    <div class="p-a50 wt-carousel-info text-white">
                                                    	<div class="carousel-line">
                                                              <h2 class="font-28 font-weight-400 m-b10">New Acropolis Museum</h2>
                                                              <p class="m-b0">Mattis ex non urna condimentum, eget eleifend diam molestie. Curabitur lorem enimnulla sed, 
                                        ...
                                        <div class="item">
                                            <div class="wt-box">
                                                <div class="ow-img wt-carousel-block gradi-black">
                                                    <img src="<?php echo base_url();?>public/images/projects/pic-4.jpg" alt="">
                                                    <div class="p-a50 wt-carousel-info text-white">
                                                    	<div class="carousel-line">
                                                              <h2 class="font-28 font-weight-400 m-b10">New Acropolis Museum</h2>
                                                              <p class="m-b0">Mattis ex non urna condimentum, eget eleifend diam molestie. Curabitur lorem enimnulla sed, 
                                        ...
                                        <div class="item">
                                            <div class="wt-box">
                                                <div class="ow-img wt-carousel-block gradi-black">
                                                    <img src="<?php echo base_url();?>public/images/projects/pic-5.jpg" alt="">
                                                    <div class="p-a50 wt-carousel-info text-white">
                                                    	<div class="carousel-line">
                                                              <h2 class="font-28 font-weight-400 m-b10">New Acropolis Museum</h2>
                                                              <p class="m-b0">Mattis ex non urna condimentum, eget eleifend diam molestie. Curabitur lorem enimnulla sed, 
                                   	...
                                   	<div class="carousel-bg-img">
                                    	<img src="<?php echo base_url();?>public/images/slider-corner.jpg" alt="">
                                    </div>
                               </div>
                            </div>
                        </div>
                                ...
                                <div class="wt-left-part2 m-experts p-t90">
                                    ...
                                    <div class="wt-team-six large-pic">
                                        <div class="wt-team-media wt-thum-bx">
                                            <img src="<?php echo base_url();?>public/images/our-team5/pic1.jpg" alt="">
                                        </div>
                                        <div class="wt-team-info text-center p-lr10 p-tb20 text-white">
                                            <h2 class="wt-team-title text-uppercase text-white font-32 font-weight-500">Robert willson</h2>
                            	...
                            	<div class="wt-right-part2 team-outer">
                            		<div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6 col-xs-100pc m-tb15">
                                            <div class="wt-team-six bg-white">
                                                <div class="wt-team-media wt-thum-bx wt-img-overlay1">
                                                    <img src="<?php echo base_url();?>public/images/our-team5/pic2.jpg" alt="">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6 col-xs-100pc m-tb15">
                                            <div class="wt-team-six bg-white">
                                                <div class="wt-team-media wt-thum-bx wt-img-overlay1">
                                                    <img src="<?php echo base_url();?>public/images/our-team5/pic3.jpg" alt="">
                                                    <div class="overlay-bx">
                                                    	<div class="overlay-icon">
                                                    		<ul class="social-icons social-square social-dark">
                                                                <li><a href="javascript:void(0);" class="fa fa-facebook"></a></li>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6 col-xs-100pc m-tb15">
                                            <div class="wt-team-six bg-white">
                                                <div class="wt-team-media wt-thum-bx wt-img-overlay1">
                                                    <img src="<?php echo base_url();?>public/images/our-team5/pic4.jpg" alt="">
                                                    <div class="overlay-bx">
                                                    	<div class="overlay-icon">
                                                    		<ul class="social-icons social-square social-dark">
                                                                <li><a href="javascript:void(0);" class="fa fa-facebook"></a></li>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6 col-xs-100pc m-tb15">
                                            <div class="wt-team-six bg-white">
                                                <div class="wt-team-media wt-thum-bx wt-img-overlay1">
                                                    <img src="<?php echo base_url();?>public/images/our-team5/pic5.jpg" alt="">
                                                    <div class="overlay-bx">
                                                    	<div class="overlay-icon">
                                                    		<ul class="social-icons social-square social-dark">
                                                                <li><a href="javascript:void(0);" class="fa fa-facebook"></a></li>
            ...
            <!-- BLOG SECTION START -->
            <div class="section-full p-t80 clearfix bg-repeat" style="background-image:url(<?php echo base_url();?>public/images/background/ptn-1.png);">
                <div class="container">
                    <div class="section-content">
                        <!-- TITLE START -->
                        <div class="section-head text-left">
                    	...
                    	<div class="row">
                            <div class="col-lg-6 col-md-12">
                            	<div class="overlay-wraper bg-no-repeat bg-cover latest-blog-dark-outer p-a20 m-b30" style="background-image:url(<?php echo base_url();?>public/images/blog/landscap-half/pic1.jpg);">
                                ...
                                <div class="overlay-wraper bg-no-repeat bg-cover latest-blog-dark-outer p-a20 m-b30" style="background-image:url(<?php echo base_url();?>public/images/blog/landscap-half/pic2.jpg);">
                                	<div class="overlay-main bg-black opacity-04"></div>
                                    <div class="latest-blog-dark text-uppercase p-a20">
                                        <h3 class="m-a0"><span class="text-white">Title of first blog post</span></h3>
                                        <div class="v-date  text-white font-weight-700">10 Aug 2023</div>
                            ...
                            <div class="col-lg-6 col-md-12">
                            	<div class="overlay-wraper bg-no-repeat bg-cover latest-blog-dark-outer2 m-b30" style="background-image:url(<?php echo base_url();?>public/images/blog/square/pic1.jpg);">
                                	<div class="overlay-main bg-black opacity-04"></div>
                                    <div class="latest-blog-square text-white">
                                        ...
                                        <a href="post-right-sidebar.html" class="letter-spacing-4 font-12 text-white text-uppercase">Read More</a>     
            ...
            <div class="section-full p-t80 p-b50 overlay-wraper bg-top-center bg-parallax"  data-stellar-background-ratio="0.5" style="background-image:url(<?php echo base_url();?>public/images/background/bg-11.jpg);">
            ...
            <div class="section-full p-t80 clearfixbg-repeat " style="background-image:url(<?php echo base_url();?>public/images/background/ptn-1.png);">
                <div class="container">
                    <div class="section-content">
                        <!-- TITLE START -->
                        <div class="section-head text-left">
                            ...
                            <div class="owl-carousel testimonial-home">
                                    ...
                                    <div class="testimonial-6">
                                        <div class="testimonial-pic-block"> 
                                            <div class="testimonial-pic">
                                                <img src="<?php echo base_url();?>public/images/testimonials/pic1.jpg" width="132" height="132" alt="">
                                            </div>
                                        </div>
                                ...
                                <div class="item">
                                    <div class="testimonial-6">
                                        <div class="testimonial-pic-block"> 
                                            <div class="testimonial-pic">
                                                <img src="<?php echo base_url();?>public/images/testimonials/pic4.jpg" width="132" height="132" alt="">
                                            </div>
                                        </div>
                                        <div class="testimonial-text clearfix bg-white">
                                            <div class="testimonial-detail clearfix">
                                ...
                                <div class="item">
                                    <div class="testimonial-6">
                                        <div class="testimonial-pic-block"> 
                                            <div class="testimonial-pic">
                                                <img src="<?php echo base_url();?>public/images/testimonials/pic2.jpg" width="132" height="132" alt="">
                                            </div>
                                        </div>
                                        <div class="testimonial-text clearfix bg-white">
                                            <div class="testimonial-detail clearfix">
                                ...
                                <div class="item">
                                    <div class="testimonial-6">
                                        <div class="testimonial-pic-block"> 
                                            <div class="testimonial-pic">
                                                <img src="<?php echo base_url();?>public/images/testimonials/pic3.jpg" width="132" height="132" alt="">
                                            </div>
                                        </div>
                                        <div class="testimonial-text clearfix bg-white">
                                            <div class="testimonial-detail clearfix">
                                        ...
                                        <div class="owl-carousel home-client-carousel owl-btn-center-v">
                                            ...
                                            <div class="item">
                                                <div class="ow-client-logo">
                                                    ...
                                                    <a href="about-1.html"><img src="<?php echo base_url();?>public/images/client-logo/w1.png" alt=""></a></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="item">
                                                <div class="ow-client-logo">
                                                    <div class="client-logo client-logo-media">
                                                    <a href="about-1.html"><img src="<?php echo base_url();?>public/images/client-logo/w2.png" alt=""></a></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="item">
                                                <div class="ow-client-logo">
                                                    <div class="client-logo client-logo-media">
                                                    <a href="about-1.html"><img src="<?php echo base_url();?>public/images/client-logo/w3.png" alt=""></a></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="item">
                                                <div class="ow-client-logo">
                                                    <div class="client-logo client-logo-media">
                                                    <a href="about-1.html"><img src="<?php echo base_url();?>public/images/client-logo/w4.png" alt=""></a></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="item">
                                                <div class="ow-client-logo">
                                                    <div class="client-logo client-logo-media">
                                                    <a href="about-1.html"><img src="<?php echo base_url();?>public/images/client-logo/w5.png" alt=""></a></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="item">
                                                <div class="ow-client-logo">
                                                    <div class="client-logo client-logo-media">
                                                    <a href="about-1.html"><img src="<?php echo base_url();?>public/images/client-logo/w6.png" alt=""></a></div>
                                                </div>
                                            </div>
                ...
                <div class="container p-t30">
                    <div class="footer-bottom-content d-flex align-items-center justify-content-between">
                        ...
                        <div class="wt-footer-bot-left">
                            <a href="#"><img src="<?php echo base_url();?>public/images/logo-dark.png" width="140" height="58" alt=""></a>
                        </div>
...
<!-- JAVASCRIPT  FILES ========================================= --> 
<script  src="<?php echo base_url();?>public/js/jquery-3.7.1.min.js"></script><!-- JQUERY.MIN JS -->
<script  src="<?php echo base_url();?>public/js/popper.min.js"></script>
<script  src="<?php echo base_url();?>public/js/bootstrap.min.js"></script><!-- BOOTSTRAP.MIN JS -->
<script  src="<?php echo base_url();?>public/js/magnific-popup.min.js"></script><!-- MAGNIFIC-POPUP JS -->
<script  src="<?php echo base_url();?>public/js/waypoints.min.js"></script><!-- WAYPOINTS JS -->
<script  src="<?php echo base_url();?>public/js/counterup.min.js"></script><!-- COUNTERUP JS -->
<script  src="<?php echo base_url();?>public/js/waypoints-sticky.min.js"></script><!-- COUNTERUP JS -->
<script  src="<?php echo base_url();?>public/js/isotope.pkgd.min.js"></script><!-- MASONRY  -->
<script  src="<?php echo base_url();?>public/js/imagesloaded.pkgd.min.js"></script><!-- MASONRY  -->
<script  src="<?php echo base_url();?>public/js/owl.carousel.min.js"></script><!-- OWL  SLIDER  -->
<script  src="<?php echo base_url();?>public/js/jquery.owl-filter.js"></script>
<script  src="<?php echo base_url();?>public/js/scrolla.min.js"></script><!-- ON SCROLL CONTENT ANIMTE   -->
<script  src="<?php echo base_url();?>public/js/custom.js"></script><!-- CUSTOM FUCTIONS  -->
<script  src="<?php echo base_url();?>public/js/shortcode.js"></script><!-- SHORTCODE FUCTIONS  -->

<!-- REVOLUTION JS FILES -->
<script  src="<?php echo base_url();?>public/plugins/revolution/revolution/js/jquery.themepunch.tools.min.js"></script>
<script  src="<?php echo base_url();?>public/plugins/revolution/revolution/js/jquery.themepunch.revolution.min.js"></script>
<script  src="<?php echo base_url();?>public/plugins/revolution/revolution/js/extensions/revolution-plugin.js"></script>

<!-- REVOLUTION SLIDER SCRIPT FILES -->
<script  src="<?php echo base_url();?>public/js/rev-script-1.js"></script>
